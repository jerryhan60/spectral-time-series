...
"""
MoiraiParallelPretrain: Pretraining module for parallel STU+Attention MOIRAI.

Identical to MoiraiHybridPretrain but uses MoiraiParallelModule, where every
layer runs both STU and Attention in parallel with a learned gate.
"""
...
from .module_parallel import MoiraiParallelModule


class MoiraiParallelPretrain(L.LightningModule):
    """
    Lightning module for pretraining the parallel STU+Attention MOIRAI model.

    Identical interface to MoiraiHybridPretrain but uses MoiraiParallelModule,
    where every layer runs both STU and Attention in parallel.
    ...
    Args:
        ...
        module_kwargs: Kwargs for MoiraiParallelModule
    ...
    def __init__(
        ...
        module: Optional[MoiraiParallelModule] = None,
        num_samples: int = 100,
        beta1: float = 0.9,
        beta2: float = 0.98,
        ...
        self.module = MoiraiParallelModule(**module_kwargs) if module is None else module
    ...
    def forward(
        ...
        """Redirects to the forward function of MoiraiParallelModule."""
        distr = self.module(
            target=target,
    ...
    def train_transform_map(self) -> dict[str, Callable[..., Transformation]]:
        """Get a dictionary of Transforms matching the MoiraiPretrain interface."""
